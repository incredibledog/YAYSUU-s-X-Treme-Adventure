...
else
{
	...
	else
	{
		...
		global.key_jump = keyboard_check(vk_space) || keyboard_check(ord("Z")) || gamepad_button_check(0,gp_face1)
		global.key_jumpp = keyboard_check_pressed(vk_space) || keyboard_check_pressed(ord("Z")) || gamepad_button_check_pressed(0,gp_face1)
		global.key_dash = keyboard_check(vk_shift) || keyboard_check(ord("X")) || keyboard_check(ord("E")) || gamepad_button_check(0,gp_face2)
		global.key_dashp = keyboard_check_pressed(vk_shift) || keyboard_check_pressed(ord("X")) || keyboard_check_pressed(ord("E")) || gamepad_button_check_pressed(0,gp_face2)
